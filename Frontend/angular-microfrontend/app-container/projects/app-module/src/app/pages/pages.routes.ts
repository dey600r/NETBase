...
export function buildRoutesPages(config: AppConfig): Routes {
    ...
    const maintenanceModule = config.remotes.find(r => r.name === AppConstants.MAINTENANCE_MODULE);
    return [
        {
        ...
        loadChildren: () =>
                    ...
                    loadRemoteModule({
                        type: 'module',
                        remoteEntry: vehicleModule?.remoteEntry || '',
                        exposedModule: vehicleModule?.exposedModule || ''
                    })
                    .then(m => m.routes)
                    .catch(err => {
        ...
        loadChildren: () =>
                    ...
                    loadRemoteModule({
                        type: 'module',
                        remoteEntry: maintenanceModule?.remoteEntry || '',
                        exposedModule: maintenanceModule?.exposedModule || ''
                    })
                    .then(m => m.routes)
                    .catch(err => {
